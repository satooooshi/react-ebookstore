      ...
      <MDBContainer className="text-center text-md-left">
        <MDBRow className="text-center text-md-left mt-3 pb-3">
          ...
          <MDBCol md="2" lg="2" xl="2" className="mx-auto mt-3">
            ...
            <p>
              <a href="#">Online Book Store with React + Material UI</a>
            </p>
            <p>
              <a href="https://github.com/satooooshi">more on github...</a>
            </p>
          </MDBCol>
          ...
          <MDBCol md="4" lg="3" xl="3" className="mx-auto mt-3">
            ...
            <p>
              <i className="fa fa-home mr-3" /> Tokyo, Japan
            </p>
          </MDBCol>
        </MDBRow>
        <hr />
          ...
          <MDBCol md="4" lg="4" className="ml-lg-0">
            <div className="text-center text-md-right">
              ...
              <li className="list-inline-item">
                  <a className="btn-floating btn-sm rgba-white-slight mx-1" href="http://github.com/satooooshi">
